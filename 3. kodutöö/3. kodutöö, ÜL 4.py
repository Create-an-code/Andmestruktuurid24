...
def tersearch(otsitav, massiiv, vasak=0, parem=None):
    ...
    if parem >= vasak: #Kui parem on suurem või võrdne vasakuga, siis jätkame
        ...
        if massiiv[kolmandik] == otsitav: #Kui otsitav element on esimese kolmandiku jagamispunkt, tagastame selle indeksi
            return kolmandik
        if massiiv[kolmandik2] == otsitav: #Kui otsitav element on kolmanda kolmandiku jagamispunkt, tagastame selle indeksi
            return kolmandik2
